    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="w-full pb-12 md:pb-24 lg:pb-32">
          <div className="container grid items-start justify-center gap-8 px-4 md:grid-cols-2 md:px-6 lg:grid-cols-3 lg:gap-12">
            ...
            <Card className="h-full shadow-lg">
              ...
              <CardFooter>
                <Button variant="secondary" className="w-full" asChild>
                  <Link href="/signup">Go Business</Link>
                </Button>
              </CardFooter>
            </Card>
            <Card className="h-full shadow-lg">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground">Contact us for a custom quote.</p>
              </CardContent>
              <CardFooter>
                <Button variant="outline" className="w-full" asChild>
